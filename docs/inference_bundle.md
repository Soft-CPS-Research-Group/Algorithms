...
- `metadata.community_name` / `metadata.bundle_version` / `metadata.description` / `metadata.alias_mapping_path`: optional ecosystem metadata used for catalogue/discovery.
- `topology`
  - `num_agents`
