# Perfis de encoding entity para Simulator 1.1.0

Snapshot: 2026-05-26

O Simulator 1.1.0 expoe todos os bundles entity ativos nos datasets principais,
...
maddpg_v2_compact:
  ...
  Não é o melhor default para Simulator 1.1.0 porque filtra várias features
...
```text
O Simulator 1.1.0 removeu a grelha antiga de forecasts derivados e o leak de
