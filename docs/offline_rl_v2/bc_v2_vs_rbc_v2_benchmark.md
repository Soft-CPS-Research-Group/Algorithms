# BC-v2 vs RBC-v2 — CityLearn Benchmark

_Generated_: 2026-05-09 20:44:22 UTC
...
_BC-v2 checkpoint root_: `/Users/guilherme.desousa/MEIA/Thesis/Project/repos/Algorithms/runs/offline_bc_v2/run-001`
_BC-v2 training seeds_: [100, 101, 102, 103, 104]
_Env seeds_ (per controller): [200, 201, 202, 203, 204, 205, 206, 207, 208, 209]  ← disjoint from RBC dataset seeds 22..31
_Total rollouts_: RBC-v2=10, BC-v2=50
...
| KPI | RBC-v2 (mean ± std) | BC-v2 (mean ± std) | Δ (BC − RBC) | Verdict |
|---|---:|---:|---:|:---|
