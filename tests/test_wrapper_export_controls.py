...
def test_wrapper_exports_only_final_episode_with_manual_bau_flags():
    ...
    wrapper._export_kpis_final_episode_only = True
    wrapper._export_timeseries_final_episode_only = True
    ...
    wrapper._manual_kpi_exported_episodes = set()
    ...
    wrapper._export_episode_kpis_if_needed(True, episode=1, is_final_episode=True)
...
def test_wrapper_can_export_manual_kpis_each_episode_but_timeseries_only_final():
    env = _DummyExportEnv()
    wrapper = Wrapper_CityLearn.__new__(Wrapper_CityLearn)
    wrapper.env = env
    wrapper._configured_render_enabled = True
    wrapper._configured_export_kpis_on_episode_end = True
    wrapper._export_final_episode_only = True
    wrapper._export_kpis_final_episode_only = False
    wrapper._export_timeseries_final_episode_only = True
    wrapper._export_include_business_as_usual = False
    wrapper._export_business_as_usual_timeseries = False
    wrapper._export_kpi_round_decimals = None
    ...
    assert wrapper._configure_episode_exports(0, 2) is True
    assert env.render_enabled is False
    assert env.export_kpis_on_episode_end is False
    wrapper._export_episode_kpis_if_needed(True, episode=0)
    ...
    assert env.export_calls == [
        {
            "filepath": "exported_kpis_ep0.csv",
            "include_business_as_usual": False,
            "export_business_as_usual_timeseries": False,
            "kpi_round_decimals": None,
        },
        {
            "filepath": "exported_kpis_ep1.csv",
            "include_business_as_usual": False,
            "export_business_as_usual_timeseries": False,
            "kpi_round_decimals": None,
        },
...
def test_wrapper_can_use_simulator_kpi_export_each_episode_but_timeseries_only_final():
    env = _DummyExportEnv()
    wrapper = Wrapper_CityLearn.__new__(Wrapper_CityLearn)
    wrapper.env = env
    wrapper._configured_render_enabled = True
    ...
    wrapper._export_kpis_final_episode_only = False
    wrapper._export_timeseries_final_episode_only = True
    wrapper._export_include_business_as_usual = True
    wrapper._export_business_as_usual_timeseries = True
    wrapper._export_kpi_round_decimals = None
    wrapper._manual_kpi_export = False
    wrapper._manual_kpi_exported_episodes = set()

    assert wrapper._configure_episode_exports(0, 2) is True
    assert env.render_enabled is False
    assert env.export_kpis_on_episode_end is True
