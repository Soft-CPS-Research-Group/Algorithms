...
RECIPES: dict[str, Recipe] = {
    ...
    "w8_ev_safe_storage_free": Recipe(
        name="w8_ev_safe_storage_free",
        bc_weight=0.300,
        bc_min_weight=0.120,
        ev_bc_multiplier=20.0,
        storage_bc_multiplier=0.08,
        zero_ev_target_weight=4.5,
        storage_l2=0.0008,
        ev_v2g_l2=0.085,
        ev_v2g_mass=0.120,
        teacher_phaseout_steps=6144,
        actor_policy_loss_weight=0.130,
        actor_policy_loss_warmup_weight=0.014,
        extra_bc_updates=3,
        extra_bc_steps=6144,
        reward_function="CostServiceCommunityDenseEVResidualRewardV54",
        reward_kwargs=(
            ...
            ("ev_schedule_deficit_penalty", 1600.0),
            ("ev_departure_deficit_penalty", 1900.0),
            ("ev_departure_missed_penalty", 5600.0),
            ("ev_over_service_tolerance", 0.05),
            ("ev_over_service_penalty", 700.0),
            ("ev_v2g_service_penalty", 2100.0),
            ("battery_throughput_penalty", 0.0018),
        ),
        reward_normalization_clip=35.0,
        teacher_policy="RBCCommunityPolicy",
        residual_policy_enabled=True,
        residual_action_scale=0.08,
        residual_action_final_scale=0.38,
        residual_action_growth_steps=4096,
        residual_storage_action_scale_multiplier=1.05,
        residual_ev_action_scale_multiplier=0.38,
        residual_deferrable_action_scale_multiplier=1.05,
        replay_observation_event_priority_mode="combined",
        n_step_returns=12,
        n_step_gamma=0.997,
        actor_policy_loss_normalization=True,
        actor_policy_loss_normalization_max_scale=130.0,
        actor_offline_bc_pretrain_steps=160,
        actor_offline_bc_pretrain_weight=0.95,
        critic_action_input_mode="final_base_delta_normalized",
        residual_delta_l2=0.010,
        actor_community_context_enabled=True,
        actor_frame_stack_steps=2,
        ...
        actor_auxiliary_hidden_layers=(64,),
        note=(
            "W8 EV-safe line: preserve the W7 residual-community gains, reduce EV "
            "residual freedom, and leave most usable freedom on storage/deferrables."
        ),
    ),
    "w8_ev_safe_cost_push": Recipe(
        name="w8_ev_safe_cost_push",
        bc_weight=0.240,
        bc_min_weight=0.080,
        ev_bc_multiplier=18.0,
        storage_bc_multiplier=0.08,
        ...
        ev_v2g_l2=0.075,
        ev_v2g_mass=0.100,
        teacher_phaseout_steps=5120,
        actor_policy_loss_weight=0.175,
        actor_policy_loss_warmup_weight=0.018,
        extra_bc_updates=2,
        extra_bc_steps=5120,
        reward_function="CostServiceCommunityDenseEVResidualRewardV54",
        reward_kwargs=(
            ("community_settlement_cost_weight", 1.32),
            ("community_peak_import_penalty", 0.0028),
            ("community_export_penalty", 0.00090),
            ("ev_connected_deficit_penalty", 160.0),
            ("ev_schedule_deficit_penalty", 1550.0),
            ("ev_departure_deficit_penalty", 1850.0),
            ("ev_departure_missed_penalty", 5600.0),
            ("ev_over_service_tolerance", 0.05),
            ("ev_over_service_penalty", 680.0),
            ("ev_v2g_service_penalty", 2050.0),
            ("battery_throughput_penalty", 0.0016),
        ),
        reward_normalization_clip=35.0,
        teacher_policy="RBCCommunityPolicy",
        residual_policy_enabled=True,
        residual_action_scale=0.09,
        residual_action_final_scale=0.42,
        residual_action_growth_steps=4096,
        residual_storage_action_scale_multiplier=1.15,
        residual_ev_action_scale_multiplier=0.42,
        residual_deferrable_action_scale_multiplier=1.10,
        replay_observation_event_priority_mode="combined",
        n_step_returns=12,
        n_step_gamma=0.997,
        actor_policy_loss_normalization=True,
        ...
        actor_offline_bc_pretrain_weight=0.90,
        critic_action_input_mode="final_base_delta_normalized",
        residual_delta_l2=0.008,
        actor_community_context_enabled=True,
        actor_frame_stack_steps=2,
        actor_auxiliary_loss_weight=0.010,
        actor_auxiliary_hidden_layers=(64,),
        note=(
            "W8 cost-push line: slightly more storage/deferrable freedom than "
            "w8_ev_safe_storage_free while keeping EV residual below W7."
        ),
    ),
