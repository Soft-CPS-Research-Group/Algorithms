...
class CentralizedCritic(nn.Module):
    ...
    def forward(
        ...
        # Compatible buildings can share one larger attention batch. Each
        # batch item remains independent, while fewer small kernels are
        # launched for centralized critic evaluation.
        ...
        for indices in grouped_indices.values():
            ...
            for index in indices:
                ...
                action_conditioned = self.action_injection(
                    ca_embeddings[current], grouped_actions[current]
                )
