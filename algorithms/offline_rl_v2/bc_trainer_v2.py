...
dims; per-dim MSE is also tracked (essential for the v2 sanity story —
...
def train_single_seed(
    ...
    *,
    ...
    """Train one BC-v2 model for one seed. Returns summary dict."""
...
def train_multi_seed(
    ...
    *,
    ...
    for seed in seeds:
        ...
        print(f"[bc_v2] training seed={seed} → {seed_dir}", flush=True)
